...
export const AddNewTaskForm: React.FC<AddNewTaskFormProps> = React.memo((props) => {

    const client = useQueryClient()
    const {mutate:createTask} = useMutation({
        mutationFn:(data:DataForCreationTask)=> tasksApi.createTask(props.todolistId, data),
    ...
    return <div>
        ...
        <PopUpComponent setIsPopUpActive={props.setIsPopUpActive}
                ...
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className={" "}><input type="text"
                        ...
                        <label className="label">
                            <span
                                ...
                                <div className={"text-red-500 text-xl"}>{formik.errors.title}</div> : "\0"}
                            </span>
                        </label>
                    </div>
                    ...
                    <div className={" "}><textarea
                        ...
                        <label className="label">
                            <span
                                ...
                                <div
                                    className={"text-red-500 text-xl"}>{formik.errors.description}</div> : "\0"}
                            </span>
                        </label>
                    </div>
                    ...
                    <div className={"flex items-center"}>
                        <input
                            ...
                            type="date"
                            placeholder={"Date"} {...formik.getFieldProps("date")}/>
                    </div>
                    <div className={"flex items-center "}>
                        <input type={"time"}
